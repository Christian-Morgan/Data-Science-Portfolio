...
## Linked Services
### Azure SQL Database
![Azure SQL Database Linked Service](../docs/data-factory/Linked-service-sql-db-setup.png)

Connects to the ecommerce-db database where CDC is enabled. Uses system-assigned managed identity for authentication.
### Azure Databricks
![Azure Databricks Linked Service](../docs/data-factory/Linked-service-databricks-setup.png)
...
![Pipeline Trigger](../docs/data-factory/batch-ingestion-trigger-adf.png)

Scheduled to run daily at 12:05 AM Eastern Time. Checks for new data and processes it through the medallion architecture.
### Lookup Activity
![Lookup Activity](../docs/data-factory/find-data-lookup-activity.png)
...
![Lookup Activity](../docs/data-factory/if_condition_setup_adf.png)
